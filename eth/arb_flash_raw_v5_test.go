...
func TestExecutorV5ActualSignedMultiAssetBundle(t *testing.T) {
    ...
    genesis := &core.Genesis{Config: params.MergedTestChainConfig, GasLimit: 30000000, BaseFee: new(big.Int), Alloc: types.GenesisAlloc{operator: {Balance: coin(1000)}, authAddress: {Code: common.FromHex(fixture.Auth)}}}
